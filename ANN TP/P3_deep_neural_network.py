...
class MLP(torch.nn.Module):
	...
	def __init__(self, input_dim, output_dim, hidden_1, hidden_2, hidden_3):
		...
		# TODO : couche cachée 3
		self.hidden3 = torch.nn.Linear(hidden_2, hidden_3)
		self.output = torch.nn.Linear(hidden_3, output_dim)
...
####### Chargement des données
		...
		model = MLP(data_train.shape[1], label_train.shape[1], params['hidden_1'], params['hidden_2'],  params['hidden_3'])

		# Initialize Weight
		torch.nn.init.uniform_(model.hidden1.weight,-0.1,0.1)
		torch.nn.init.uniform_(model.hidden2.weight,-0.1,0.1)
		...
		if i == 2:
		# MODELE 2 
			torch.nn.init.uniform_(model.hidden1.weight,-0.00001,0.00001)
			torch.nn.init.uniform_(model.hidden2.weight,-0.00001,0.00001)
